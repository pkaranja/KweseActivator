...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Ptah Karanja">
    <link rel="icon" href="favicon.ico">

    <title>Kwese Activator</title>
  ...
  <body>
    <form class="form-signin">
      <div class="text-center mb-4">
        <img class="mb-4" src="images/logo_new.png" width="300px">
      </div>

      <div class="form-label-group">
        <input type="text" id="inputName" class="form-control" placeholder="Enter full name" required autofocus>
